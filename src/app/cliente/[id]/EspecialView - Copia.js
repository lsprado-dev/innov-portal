                                ...
                                <>
                                  <button onClick={() => { 
                                    setFormProcesso({ 
                                      ...
                                      taxas_pendentes: proc.taxas_pendentes || '', 
                                      taxas_pagas: proc.taxas_pagas || '' 
                                    }); 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="bg-[#1b263b] p-4 rounded-lg border border-emerald-500/20">
                          ...
                          {proc.taxas_pagas ? <p className="text-sm text-zinc-300 whitespace-pre-wrap">{proc.taxas_pagas}</p> : <p className="text-xs text-zinc-600 italic">Nenhum pagamento ainda.</p>}
                        </div>
                      </div>
